...
class IonSettingsSection(BaseSection):
    ...
    def _get_selected_ion_types(self) -> list[str]:
        """Get list of selected ion types."""
        selected = []
    ...
    def get_ion_match_parameters(self) -> IonMatchParameters:
        """
        Create IonMatchParameters object from current settings.
        
        Returns:
            IonMatchParameters instance
        """
        self._sync_to_state()
